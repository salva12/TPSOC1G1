...
def Prioridades(procesos):
    ...
    while clock<=tiempototal_cpu:
        ...
        if len(procesoparaprobar)>0 and ant==cola_listos[0][0]:
            procesoparaprobar[-1][4]=(procesoparaprobar[-1][4])+1
        else:
            procesoparaprobar.append([cola_listos[0][0],cola_listos[0][1],cola_listos[0][2],cola_listos[0][3],1,cola_listos[0][5]]) 
